...
The log Bayes factor for $R_0$ over Foi is `r toString(format(round(out$log_Bayes_R0_FOI[2], 2), nsmall = 2))` in range [`r toString(format(round(out$log_Bayes_R0_FOI[1], 2), nsmall = 2))`, `r toString(format(round(out$log_Bayes_R0_FOI[3], 2), nsmall = 2))`]. 
